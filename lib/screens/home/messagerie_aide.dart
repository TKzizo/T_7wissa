...
class _MessageHelpPageState extends State<MessageHelpPage> {
  ...
  Widget build(BuildContext context) {
      ...
      children: <Widget> [Text(
                          '\n  Cliquez sur l’icone qui represente un message\n  en bas de votre page.\n',
