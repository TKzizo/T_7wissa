...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void setCustomMapPin() async {
    pinLocationIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(-12, -12)), 'assets/jesuisenpanne.png');
    //ICONE EN PANNE
    panneIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(-12, -12)), 'assets/jesuisenpanne.png');
    //ICONE ACCIDENT
    accidentIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(-12, -12)), 'assets/accident.png');
    //ICONE ANIMAUX
    animauxIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(-12, -12)), 'assets/animaux.png');
    //ICONE BARRAGE
    barrageIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(-12, -12)), 'assets/barrage.png');
    //ICONE AIDE
    aideIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(-12, -12)), 'assets/besoindaide.png');
    //ICONDE PAUSE
    pauseIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(-12, -12)), 'assets/pause.png');
    //ICONE RADAR
    radarIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(-12, -12)), 'assets/radar.png');
    //ICONE ROUTE
    routeIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(-12, -12)), 'assets/route.png');
    //ICONE UTILISATEUR MALE
    maleIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(-12, -12)), 'assets/utilisateurmale.png');
    //ICONE UTILISATEUR FEMALE
    destinationIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(-12, -12)), 'assets/destination.png');
    //ICONE DESTINATION
  }
  ...
  void updateuserLocation(String userId) {
    _getCurrentLocation();
    //
    Firestore.instance.collection('utilisateur').document(userId).updateData({
      'vitesse': position.speed == null ? 0.0 : position.speed.toDouble(),
      'latitude':
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        for (int i = 0; i < snapshot.data.documents.length; i++) {
          String icon = (snapshot.data.documents[i]['icon']).toString() == null
              ? ' '
              : (snapshot.data.documents[i]['icon']).toString();
          if (icon == 'route') {
            allMarkers.add(new Marker(
              position: new LatLng(
                  (snapshot.data.documents[i]['latitude']) == null
                      ? 0.0
              ...
              icon: routeIcon,
              onTap: () => _markerAlertPressed(
                  (snapshot.data.documents[i]['senderId']).toString() == null
                      ? ' '
                      : (snapshot.data.documents[i]['senderId']).toString(),
                  ...
                  allMarkers.add(new Marker(
                    ...
                    onTap: () => _markerAlertPressed(
                        (snapshot.data.documents[i]['senderId']).toString() ==
                                null
                            ? ' '
                            : (snapshot.data.documents[i]['senderId'])
                                .toString(),
                        (snapshot.data.documents[i]['image']).toString() == null
                            ? "Alerte ! "
                            : (snapshot.data.documents[i]['image']).toString()),
                        ...
                        if (icon == 'panne') {
                          ...
                          if (icon == 'destination') {
                            allMarkers.add(new Marker(
                              ...
                              onTap: () => _markerDestinationPressed(
                                  _current_userId,
                                  (snapshot.data.documents[i]['text']) == null
                                      ? 0.0
      ...
      builder: (context, snapshot) {
        ...
        for (int i = 0; i < snapshot.data.documents.length; i++) {
          if (allUsers.contains(
              (snapshot.data.documents[i]['uid']).toString() == null
                  ? "uid"
                  : (snapshot.data.documents[i]['uid']).toString())) {
            allMarkers.add(new Marker(
              position: new LatLng(
                  (snapshot.data.documents[i]['latitude']) == null
                      ? 0.0
              ...
              icon: maleIcon,
              infoWindow: InfoWindow(
                title: (snapshot.data.documents[i]['identifiant']).toString() ==
                        null
                    ? "user"
                    : (snapshot.data.documents[i]['identifiant']).toString(),
                onTap: () => _markerUserPressed(
                    (snapshot.data.documents[i]['uid']).toString() == null
                        ? null
                        : (snapshot.data.documents[i]['uid']).toString()),
              ),
  ...
  Widget userListeMarkers() {
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        for (int i = 0; i < snapshot.data.documents.length; i++) {
          allUsers.add((snapshot.data.documents[i]['user']).toString() == null
              ? " "
              : (snapshot.data.documents[i]['user']).toString());
        }
          ...
          children: [
            ...
            Row(
                ...
                children: <Widget>[
                  ...
                  StreamBuilder<UserData>(
                      stream:
                          DatabaseService(uid: user.uid).utilisateursDonnees,
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          _current_userId = user.uid;
              ...
              child: StreamBuilder<UserData>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      return Text(userData.identifiant);
                    } else {
                      return Text('Loading');
                    }
                  }),
  ...
  _buildRecievedMessageslistItem(BuildContext ctx, DocumentSnapshot document) {
    if ((document['image']) != null) {
      return (ListTile(
          ...
          subtitle: Text(document['sender'].toString(),
              style: const TextStyle(
                  color: Colors.teal,
                  fontWeight: FontWeight.w400,
                  fontFamily: "Roboto",
          ...
          trailing: Text(document['time'].toString(),
              style: const TextStyle(
          ...
          children: <Widget>[
            ListTile(
              ...
              trailing: IconButton(
                onPressed: () async {
                  print(_current_user);
                  ChatService(uid: _current_grp.toString()).envoyer_mesg(
                      _current_grp,
                      'On a démarré!',
                      _current_user,
                      _current_userId,
            ...
            ListTile(
              ...
              trailing: IconButton(
                onPressed: () async {
                  ChatService(uid: _current_grp.toString()).envoyer_mesg(
                      /*_current_grp.toString()*/ _current_grp,
                      'Je suis arrivé(e)',
                      _current_user,
                      _current_userId,
                      null);
            ...
            ListTile(
              ...
              trailing: IconButton(
                onPressed: () async {
                  CreationGroupeServises(uid: _current_grp.toString())
                      .marquer_Alerte(
                          _current_grp,
                          "j'ai besoin d'aide !",
                          position.longitude,
                  ...
                  allMarkers.add(new Marker(
                    ...
                    icon: aideIcon,
                    onTap: () => _markerAlertPressed(
                        _current_userId, "j'ai besoin d'aide ! "),
                  ));
                  setState(() {
                    _child = _mapWidget();
                  });
              ...
              trailing: IconButton(
                onPressed: () async {
                  ...
                  allMarkers.add(new Marker(
                    ...
                    icon: panneIcon,
                    onTap: () => _markerAlertPressed(
                        _current_userId, "je suis en panne"),
                  ));
                  setState(() {
                    _child = _mapWidget();
                  });
              ...
              trailing: IconButton(
                onPressed: () async {
                  ...
                  allMarkers.add(new Marker(
                    ...
                    icon: accidentIcon,
                    onTap: () =>
                        _markerAlertPressed(_current_userId, "accident"),
                  ));
                  setState(() {
                    _child = _mapWidget();
                  });
              ...
              trailing: IconButton(
                onPressed: () async {
                  ...
                  allMarkers.add(new Marker(
                    ...
                    icon: routeIcon,
                    onTap: () => _markerAlertPressed(
                        _current_userId, "Route endommagée"),
                  ));
                  setState(() {
                    _child = _mapWidget();
                  });
              ...
              trailing: IconButton(
                onPressed: () async {
                  ...
                  allMarkers.add(new Marker(
                    ...
                    icon: barrageIcon,
                    onTap: () =>
                        _markerAlertPressed(_current_userId, "Alerte barrage"),
                  ));
                  setState(() {
                    _child = _mapWidget();
                  });
                          ...
                          builder: (context, snapshot) {
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (ctx, index) =>
                                  (_buildRecievedMessageslistItem(
                                      ctx, snapshot.data.documents[index])),
                            );
                          })),
                  ...
                  PositionedDirectional(
                      ...
                      child: SizedBox(
                        ...
                        child: ListTile(
                          ...
                          trailing: IconButton(
                            onPressed: () async {
                              ChatService(uid: currentGroupe.toString())
                                  .envoyer_mesg(currentGroupe.toString(), text,
                                      _current_user, _current_userId, null);
                            },
                            icon: Icon(Icons.send, color: Colors.greenAccent),
                          ),
                        ),
...
/*Groupes*/
                      ...
                      child: StreamBuilder(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return ListView.builder(
                              itemExtent: 80.0,
                              itemCount: snapshot.data.documents.length,
                              itemBuilder: (ctx, index) => (_buildlistItem(
                                  ctx, snapshot.data.documents[index])),
                            );
                          })),
                  PositionedDirectional(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.all(Radius.circular(20.0))),
            content: Text(
                "Vous n'avez pas le droit de lancer cette fonctionalité car vous n'êtes pas l'administrateur de ce groupe."),
            actions: <Widget>[
              MaterialButton(
                elevation: 5.0,
                child: Text('OK'),
  ...
  _buildlistItem(BuildContext ctx, DocumentSnapshot document) {
    DocumentReference ref =
        Firestore.instance.collection('groupe').document(_current_grp);
...
//bool isSwitched=documentFields['statu'];
            return ListTile(
              title: Row(
                  ...
                  children: <Widget>[
                    Text(documentFields['nom'].toString(),
                        style: const TextStyle(
                            color: const Color(0xff3d3d3d),
                            fontWeight: FontWeight.w400,
                            fontFamily: "Roboto",
              ...
              subtitle: Text("Admin : " + documentFields['admin'].toString(),
                  style: const TextStyle(
                      color: const Color(0xde3d3d3d),
                      fontWeight: FontWeight.w400,
                      fontFamily: "Roboto",
       ...
       height: 30,
        ...
        /*       Switch(
            ...
            activeColor: Colors.green,
                  ...
                  IconButton(
                    onPressed: () => _quittergroupe(
                        document.documentID, documentFields['uid']),
                    icon: Icon(
                      Icons.exit_to_app,
              ...
              onTap: () async {
               ...
               /* Firestore.instance
                .collection("utilisateur").document("$_current_userId")
                .collection("tokens").document("groupe/$_current_grp/Markers")
                .setData({
                  "token" : "groupe/$_current_grp/Markers"});*/
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            TextFormField(
                              ...
                              validator: (val) =>
                                  val.isEmpty ? 'Donner un nom ' : null,
                              onChanged: (val) {
                                setState(() => nom = val);
                              },
                            ),
                        ...
                        child: Material(
                          ...
                          child: MaterialButton(
                            ...
                            onPressed: () => {
                              if (_formKey.currentState.validate())
                                {
                                  ref.updateData({"destination": changer_dest })
                                }
                            },
                          ),
                        ),
...
/* content: Stack(children: [
                ...
                child: Stack(children: [
                  PositionedDirectional(
                    ...
                    child: SizedBox(
                        width: (MediaQuery.of(context).size.width) * 0.8,
                        height: (MediaQuery.of(context).size.height) * 0.03,
                        child: Text("Ajouter un point de repos ",
                            style: const TextStyle(
                                color: const Color(0xde204f6f),
                                fontWeight: FontWeight.w500,
                                fontFamily: "Roboto",
                      ...
                      child: FloatingActionButton(
                        ...
                        onPressed: () {
                          if (currentUser.uid == _current_grp_adminID) {
                            showSearch(
                                context: context, delegate: UserSeach(pass));
                          } else {
                            showSearch(
                                context: context, delegate: UserSearch(pass));
                          }
                        },
                        child: Icon(
                          Icons.add,
                              ...
                              return (StreamBuilder<DocumentSnapshot>(
                                  ...
                                  builder: (BuildContext context,
                                      AsyncSnapshot<DocumentSnapshot>
                                          snapshot) {
                                    if (snapshot.hasData) {
                                      Map<String, dynamic> documentAdmin =
                                          snapshot.data.data;
                                      print('object2');
                                      print(documentAdmin['admin'].toString() ==
                                              null
                                          ? " "
                                          : documentAdmin['admin'].toString());
                                      print(userData.identifiant);

                                      return FloatingActionButton(
                                        heroTag: 'btn10',
                                        onPressed: () => {
                                          if (documentAdmin['admin'] ==
                                              userData.identifiant)
                                            {
                ...
                leading: (Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage('${documentFields['image_url']}'),
                    ),
                  ),
                )),
                title: Text(documentFields['identifiant'],
                    style: const TextStyle(
                    ...
                    textAlign: TextAlign.left),
                trailing: IconButton(
                    icon: Icon(Icons.place, color: const Color(0xff339899)),
                    onPressed: () => {
                          _controller
                              .animateCamera(CameraUpdate.newCameraPosition(
                            CameraPosition(
                                target: LatLng(documentFields['latitude'],
                                    documentFields['longitude']),
                                zoom: 16.0),
                          )),
                        }),
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Container(
              ...
              height: (MediaQuery.of(context).size.height) *
                  0.4, // Change as per your requirement
              width: (MediaQuery.of(context).size.width) * 0.7,
              child: StreamBuilder(
                  stream: Firestore.instance
                      .collection('groupe')
                  ...
                  builder: (context, snapshot) {
                    if (!snapshot.hasData) {
                      ...
                      return ListView.builder(
                        itemExtent: 80.0,
                        itemCount: snapshot.data.documents.length,
                        itemBuilder: (ctx, index) => (buildSugglistItem(
                            ctx, snapshot.data.documents[index], _current_grp)),
                      );
                    }
                  }),
            ),
                ...
                child: Stack(children: [
                  ...
                  Container(
                      ...
                      child: StreamBuilder(
                          ...
                          builder: (context, snapshot) {
                            if (!snapshot.hasData)
                              return const Text("aucune invitation",
                                  style: const TextStyle(
                                      color: const Color(0xff3d3d3d),
                                      fontWeight: FontWeight.w400,
                                      fontFamily: "Roboto",
  ...
  buildInvitationlistItem(
      BuildContext ctx, DocumentSnapshot document, String userID) {
    return (ListTile(
      title:
        ...
        IconButton(
          onPressed: () => _refuserInvitation(document.documentID,
              userID) /*_refuserInvitation(document.documentID)*/,
          icon: Icon(
            Icons.cancel,
            color: const Color(0xffff5722),
            size: 30,
        ...
        IconButton(
          onPressed: () => _accepterInvitation(
              document.documentID, document['groupeID'], userID), //a changer
          icon: Icon(
            Icons.check_circle,
      ...
      subtitle: Text("Admin : " + document['admin'],
          style: const TextStyle(
              color: const Color(0xde3d3d3d),
              fontWeight: FontWeight.w400,
              fontFamily: "Roboto",
  ...
  buildSugglistItem(
      BuildContext ctx, DocumentSnapshot document, String idGroup) {
    return (StreamBuilder<DocumentSnapshot>(
        stream: provideDocumentFieldStream("utilisateur", document['user']),
        builder:
            (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
            ...
            return ListView(children: <Widget>[
              ListTile(
                ...
                title: Row(
                    ...
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      Text(documentFields['identifiant'].toString(),
                          style: const TextStyle(
                              color: const Color(0xde000000),
                              fontWeight: FontWeight.w400,
                              fontFamily: "Roboto",
                      ...
                      IconButton(
                        onPressed: () =>
                            _refuserSugg(idGroup, document.documentID),
                        /*_refuserInvitation(document.documentID)*/
                        icon: Icon(
                          Icons.cancel,
                          color: const Color(0xffff5722),
                          size: 30,
                      ...
                      IconButton(
                        onPressed: () => _accepterSugg(document.documentID,
                            idGroup, document['id']), //a changer
                        icon: Icon(
                          Icons.check_circle,
                          color: const Color(0xff13ef81),
                          size: 30,
